...
Environment:
  ...
  NCCL_MPICH_AWS_OFI_NCCL_VERSION  AWS OFI NCCL plugin version for the MPICH NCCL benchmark image. Default: 1.19.0
...
nccl_mpich_aws_ofi_nccl_version="${NCCL_MPICH_AWS_OFI_NCCL_VERSION:-1.19.0}"
